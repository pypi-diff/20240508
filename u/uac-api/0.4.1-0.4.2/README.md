# Comparing `tmp/uac-api-0.4.1.tar.gz` & `tmp/uac-api-0.4.2.tar.gz`
...
### Comparing `uac-api-0.4.1/setup.py` & `uac-api-0.4.2/setup.py`
...
### Comparing `uac-api-0.4.1/uac_api/audits.py` & `uac-api-0.4.2/uac_api/audits.py`
