# Comparing `tmp/BioSAK-1.88.4.tar.gz` & `tmp/BioSAK-1.88.5.tar.gz`
...
### Comparing `BioSAK-1.88.4/BioSAK/boxplot.py` & `BioSAK-1.88.5/BioSAK/boxplot.py`
...
### Comparing `BioSAK-1.88.4/BioSAK/select_seq.py` & `BioSAK-1.88.5/BioSAK/select_seq.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.88.4/BioSAK/sep_reads_by_barcode.py` & `BioSAK-1.88.5/BioSAK/sep_reads_by_barcode.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.88.4/BioSAK/slice_seq.py` & `BioSAK-1.88.5/BioSAK/slice_seq.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.88.4/BioSAK/split_fasta.py` & `BioSAK-1.88.5/BioSAK/split_fasta.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.88.4/BioSAK/split_folder.py` & `BioSAK-1.88.5/BioSAK/split_folder.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.88.4/BioSAK/split_sam.py` & `BioSAK-1.88.5/BioSAK/split_sam.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.88.4/BioSAK/submitHPC.py` & `BioSAK-1.88.5/BioSAK/submitHPC.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.88.4/BioSAK/subset_GTDB_meta.py` & `BioSAK-1.88.5/BioSAK/subset_GTDB_meta.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.88.4/BioSAK/subset_df.py` & `BioSAK-1.88.5/BioSAK/subset_df.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.88.4/BioSAK/subset_tree.py` & `BioSAK-1.88.5/BioSAK/subset_tree.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.88.4/BioSAK/tmp_1.py` & `BioSAK-1.88.5/BioSAK/tmp_1.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.88.4/BioSAK/top_16S_hits.py` & `BioSAK-1.88.5/BioSAK/top_16S_hits.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.88.4/BioSAK/top_hits_in_a_group.py` & `BioSAK-1.88.5/BioSAK/top_hits_in_a_group.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.88.4/BioSAK/transpose.py` & `BioSAK-1.88.5/BioSAK/transpose.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.88.4/BioSAK/usearch_uc.py` & `BioSAK-1.88.5/BioSAK/usearch_uc.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.88.4/BioSAK/wilcox.py` & `BioSAK-1.88.5/BioSAK/wilcox.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.88.4/BioSAK.egg-info/SOURCES.txt` & `BioSAK-1.88.5/BioSAK.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `BioSAK-1.88.4/LICENSE` & `BioSAK-1.88.5/LICENSE`

 * *Files identical despite different names*

### Comparing `BioSAK-1.88.4/README.md` & `BioSAK-1.88.5/README.md`

 * *Files identical despite different names*

### Comparing `BioSAK-1.88.4/bin/BioSAK` & `BioSAK-1.88.5/bin/BioSAK`

 * *Files identical despite different names*

### Comparing `BioSAK-1.88.4/setup.py` & `BioSAK-1.88.5/setup.py`
