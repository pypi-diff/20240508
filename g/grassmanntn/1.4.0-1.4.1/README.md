# Comparing `tmp/grassmanntn-1.4.0.tar.gz` & `tmp/grassmanntn-1.4.1.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "grassmanntn-1.4.0.tar", last modified: Thu Dec 14 05:42:32 2023, max compression
+gzip compressed data, was "grassmanntn-1.4.1.tar", last modified: Wed May  8 09:05:33 2024, max compression
```

## Comparing `grassmanntn-1.4.0.tar` & `grassmanntn-1.4.1.tar`

### file list

```diff
@@ -1,20 +1,20 @@
-drwxrwxr-x   0 ayosp     (1000) ayosp     (1000)        0 2023-12-14 05:42:32.590573 grassmanntn-1.4.0/
--rw-rw-r--   0 ayosp     (1000) ayosp     (1000)    11357 2023-06-26 02:27:06.000000 grassmanntn-1.4.0/LICENSE.txt
--rw-rw-r--   0 ayosp     (1000) ayosp     (1000)     1325 2023-12-14 05:42:32.590573 grassmanntn-1.4.0/PKG-INFO
--rw-rw-r--   0 ayosp     (1000) ayosp     (1000)      553 2023-06-26 04:06:04.000000 grassmanntn-1.4.0/README.md
-drwxrwxr-x   0 ayosp     (1000) ayosp     (1000)        0 2023-12-14 05:42:32.590573 grassmanntn-1.4.0/grassmanntn/
--rw-rw-r--   0 ayosp     (1000) ayosp     (1000)   208047 2023-12-06 09:37:41.000000 grassmanntn-1.4.0/grassmanntn/__init__.py
--rw-rw-r--   0 ayosp     (1000) ayosp     (1000)    27565 2023-10-19 06:17:49.000000 grassmanntn-1.4.0/grassmanntn/arith.py
--rw-rw-r--   0 ayosp     (1000) ayosp     (1000)     7833 2023-10-13 09:12:22.000000 grassmanntn-1.4.0/grassmanntn/example.py
--rw-rw-r--   0 ayosp     (1000) ayosp     (1000)     7895 2023-12-06 05:57:14.000000 grassmanntn-1.4.0/grassmanntn/example_block.py
--rw-rw-r--   0 ayosp     (1000) ayosp     (1000)   147765 2023-12-06 09:40:38.000000 grassmanntn-1.4.0/grassmanntn/gauge2d.py
--rw-rw-r--   0 ayosp     (1000) ayosp     (1000)   147810 2023-12-06 09:39:57.000000 grassmanntn-1.4.0/grassmanntn/gauge2d_block.py
--rw-rw-r--   0 ayosp     (1000) ayosp     (1000)   693592 2023-05-29 12:33:44.000000 grassmanntn-1.4.0/grassmanntn/param.py
-drwxrwxr-x   0 ayosp     (1000) ayosp     (1000)        0 2023-12-14 05:42:32.590573 grassmanntn-1.4.0/grassmanntn.egg-info/
--rw-rw-r--   0 ayosp     (1000) ayosp     (1000)     1325 2023-12-14 05:42:32.000000 grassmanntn-1.4.0/grassmanntn.egg-info/PKG-INFO
--rw-rw-r--   0 ayosp     (1000) ayosp     (1000)      384 2023-12-14 05:42:32.000000 grassmanntn-1.4.0/grassmanntn.egg-info/SOURCES.txt
--rw-rw-r--   0 ayosp     (1000) ayosp     (1000)        1 2023-12-14 05:42:32.000000 grassmanntn-1.4.0/grassmanntn.egg-info/dependency_links.txt
--rw-rw-r--   0 ayosp     (1000) ayosp     (1000)       30 2023-12-14 05:42:32.000000 grassmanntn-1.4.0/grassmanntn.egg-info/requires.txt
--rw-rw-r--   0 ayosp     (1000) ayosp     (1000)       12 2023-12-14 05:42:32.000000 grassmanntn-1.4.0/grassmanntn.egg-info/top_level.txt
--rw-rw-r--   0 ayosp     (1000) ayosp     (1000)       79 2023-12-14 05:42:32.590573 grassmanntn-1.4.0/setup.cfg
--rw-rw-r--   0 ayosp     (1000) ayosp     (1000)     1914 2023-12-14 05:42:08.000000 grassmanntn-1.4.0/setup.py
...
### Comparing `grassmanntn-1.4.0/LICENSE.txt` & `grassmanntn-1.4.1/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `grassmanntn-1.4.0/PKG-INFO` & `grassmanntn-1.4.1/PKG-INFO`
...
-Download-URL: https://github.com/ayosprakob/grassmanntn/archive/refs/tags/v_140.tar.gz
...
### Comparing `grassmanntn-1.4.0/README.md` & `grassmanntn-1.4.1/README.md`

 * *Files identical despite different names*

### Comparing `grassmanntn-1.4.0/grassmanntn/__init__.py` & `grassmanntn-1.4.1/grassmanntn/__init__.py`
...
### Comparing `grassmanntn-1.4.0/grassmanntn/arith.py` & `grassmanntn-1.4.1/grassmanntn/arith.py`

 * *Files identical despite different names*

### Comparing `grassmanntn-1.4.0/grassmanntn/example.py` & `grassmanntn-1.4.1/grassmanntn/example.py`

 * *Files identical despite different names*

### Comparing `grassmanntn-1.4.0/grassmanntn/example_block.py` & `grassmanntn-1.4.1/grassmanntn/example_block.py`

 * *Files identical despite different names*

### Comparing `grassmanntn-1.4.0/grassmanntn/gauge2d.py` & `grassmanntn-1.4.1/grassmanntn/gauge2d.py`

 * *Files identical despite different names*

### Comparing `grassmanntn-1.4.0/grassmanntn/gauge2d_block.py` & `grassmanntn-1.4.1/grassmanntn/gauge2d_block.py`

 * *Files identical despite different names*

### Comparing `grassmanntn-1.4.0/grassmanntn/param.py` & `grassmanntn-1.4.1/grassmanntn/param.py`

 * *Files identical despite different names*

### Comparing `grassmanntn-1.4.0/grassmanntn.egg-info/PKG-INFO` & `grassmanntn-1.4.1/grassmanntn.egg-info/PKG-INFO`
...
### Comparing `grassmanntn-1.4.0/setup.py` & `grassmanntn-1.4.1/setup.py`
