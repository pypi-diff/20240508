# Comparing `tmp/caillou-0.0.5-py3-none-any.whl.zip` & `tmp/caillou-0.0.6-py3-none-any.whl.zip`

## zipinfo {}

```diff
@@ -1,15 +1,15 @@
-Zip file size: 23422 bytes, number of entries: 13
+Zip file size: 23421 bytes, number of entries: 13
 -rw-r--r--  2.0 unx     2071 b- defN 80-Jan-01 00:00 caillou/__init__.py
...
--rw-r--r--  2.0 unx    35149 b- defN 80-Jan-01 00:00 caillou-0.0.5.dist-info/LICENSE
--rw-r--r--  2.0 unx     1685 b- defN 80-Jan-01 00:00 caillou-0.0.5.dist-info/METADATA
--rw-r--r--  2.0 unx       88 b- defN 80-Jan-01 00:00 caillou-0.0.5.dist-info/WHEEL
--rw-r--r--  2.0 unx       49 b- defN 80-Jan-01 00:00 caillou-0.0.5.dist-info/entry_points.txt
-?rw-r--r--  2.0 unx     1050 b- defN 16-Jan-01 00:00 caillou-0.0.5.dist-info/RECORD
-13 files, 63598 bytes uncompressed, 21674 bytes compressed:  65.9%
...
-Filename: caillou-0.0.5.dist-info/LICENSE
+Filename: caillou-0.0.6.dist-info/LICENSE
 Comment: 
 
-Filename: caillou-0.0.5.dist-info/METADATA
+Filename: caillou-0.0.6.dist-info/METADATA
 Comment: 
 
-Filename: caillou-0.0.5.dist-info/WHEEL
+Filename: caillou-0.0.6.dist-info/WHEEL
 Comment: 
 
-Filename: caillou-0.0.5.dist-info/entry_points.txt
+Filename: caillou-0.0.6.dist-info/entry_points.txt
 Comment: 
 
-Filename: caillou-0.0.5.dist-info/RECORD
...
## Comparing `caillou-0.0.5.dist-info/LICENSE` & `caillou-0.0.6.dist-info/LICENSE`

 * *Files identical despite different names*

## Comparing `caillou-0.0.5.dist-info/METADATA` & `caillou-0.0.6.dist-info/METADATA`
...
## Comparing `caillou-0.0.5.dist-info/RECORD` & `caillou-0.0.6.dist-info/RECORD`
...
-caillou-0.0.5.dist-info/LICENSE,sha256=OXLcl0T2SZ8Pmy2_dmlvKuetivmyPd5m1q-Gyd-zaYY,35149
-caillou-0.0.5.dist-info/METADATA,sha256=LVY-wsyKpjINREnsxQUFqoz1uY8kYBB5GvQ0GSq_4vQ,1685
-caillou-0.0.5.dist-info/WHEEL,sha256=sP946D7jFCHeNz5Iq4fL4Lu-PrWrFsgfLXbbkciIZwg,88
-caillou-0.0.5.dist-info/entry_points.txt,sha256=wM8bpx5q9aVcvwpMOx0WN7muwT3f8UfrS9-XnN1VgL0,49
-caillou-0.0.5.dist-info/RECORD,,
