# Comparing `tmp/charzr_lib-1.0.8.tar.gz` & `tmp/charzr_lib-1.0.9.tar.gz`
...
## Comparing `charzr_lib-1.0.8.tar` & `charzr_lib-1.0.9.tar`
...
### Comparing `charzr_lib-1.0.8/README.md` & `charzr_lib-1.0.9/README.md`

 * *Files identical despite different names*

### Comparing `charzr_lib-1.0.8/charzr_lib/pokemon.csv` & `charzr_lib-1.0.9/charzr_lib/pokemon.csv`

 * *Files identical despite different names*

### Comparing `charzr_lib-1.0.8/charzr_lib/random_pokemon.py` & `charzr_lib-1.0.9/charzr_lib/random_pokemon.py`
