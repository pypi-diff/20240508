# Comparing `tmp/dataset_tools-0.0.82.tar.gz` & `tmp/dataset-tools-0.0.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "dataset_tools-0.0.82.tar", last modified: Wed May  8 09:49:59 2024, max compression
+gzip compressed data, was "dataset-tools-0.0.9.tar", last modified: Mon Jun  5 13:38:22 2023, max compression
```

## Comparing `dataset_tools-0.0.82.tar` & `dataset-tools-0.0.9.tar`

### file list

```diff
@@ -1,88 +1,54 @@
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-08 09:49:59.904356 dataset_tools-0.0.82/
--rw-r--r--   0 runner    (1001) docker     (127)    11357 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/LICENSE
--rw-r--r--   0 runner    (1001) docker     (127)     1965 2024-05-08 09:49:59.904356 dataset_tools-0.0.82/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (127)       16 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/README.md
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-08 09:49:59.880356 dataset_tools-0.0.82/dataset_tools/
--rw-r--r--   0 runner    (1001) docker     (127)     1845 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/__init__.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-08 09:49:59.880356 dataset_tools-0.0.82/dataset_tools/convert/
--rw-r--r--   0 runner    (1001) docker     (127)     1363 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/convert/__init__.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-08 09:49:59.880356 dataset_tools-0.0.82/dataset_tools/convert/cityscapes/
--rw-r--r--   0 runner    (1001) docker     (127)       83 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/convert/cityscapes/__init__.py
--rw-r--r--   0 runner    (1001) docker     (127)    22156 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/convert/cityscapes/main.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-08 09:49:59.880356 dataset_tools-0.0.82/dataset_tools/convert/coco/
--rw-r--r--   0 runner    (1001) docker     (127)       76 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/convert/coco/__init__.py
--rw-r--r--   0 runner    (1001) docker     (127)    24946 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/convert/coco/main.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-08 09:49:59.880356 dataset_tools-0.0.82/dataset_tools/convert/pascal/
--rw-r--r--   0 runner    (1001) docker     (127)       79 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/convert/pascal/__init__.py
--rw-r--r--   0 runner    (1001) docker     (127)    19519 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/convert/pascal/main.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-08 09:49:59.880356 dataset_tools-0.0.82/dataset_tools/data/
--rw-r--r--   0 runner    (1001) docker     (127)        0 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/data/__init__.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-08 09:49:59.880356 dataset_tools-0.0.82/dataset_tools/data/download_urls/
--rw-r--r--   0 runner    (1001) docker     (127)        0 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/data/download_urls/__init__.py
--rw-r--r--   0 runner    (1001) docker     (127)   229217 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/data/download_urls/released_datasets.json
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-08 09:49:59.896356 dataset_tools-0.0.82/dataset_tools/fonts/
--rw-r--r--   0 runner    (1001) docker     (127)   491496 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/fonts/FiraSans-Black.ttf
--rw-r--r--   0 runner    (1001) docker     (127)   511708 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/fonts/FiraSans-BlackItalic.ttf
--rw-r--r--   0 runner    (1001) docker     (127)   473876 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/fonts/FiraSans-Bold.ttf
--rw-r--r--   0 runner    (1001) docker     (127)   491048 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/fonts/FiraSans-BoldItalic.ttf
--rw-r--r--   0 runner    (1001) docker     (127)   481124 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/fonts/FiraSans-ExtraBold.ttf
--rw-r--r--   0 runner    (1001) docker     (127)   521088 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/fonts/FiraSans-ExtraBoldItalic.ttf
--rw-r--r--   0 runner    (1001) docker     (127)   431308 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/fonts/FiraSans-ExtraLight.ttf
--rw-r--r--   0 runner    (1001) docker     (127)   446916 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/fonts/FiraSans-ExtraLightItalic.ttf
--rw-r--r--   0 runner    (1001) docker     (127)   456436 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/fonts/FiraSans-Italic.ttf
--rw-r--r--   0 runner    (1001) docker     (127)   433824 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/fonts/FiraSans-Light.ttf
--rw-r--r--   0 runner    (1001) docker     (127)   447376 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/fonts/FiraSans-LightItalic.ttf
--rw-r--r--   0 runner    (1001) docker     (127)   441384 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/fonts/FiraSans-Medium.ttf
--rw-r--r--   0 runner    (1001) docker     (127)   456840 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/fonts/FiraSans-MediumItalic.ttf
--rw-r--r--   0 runner    (1001) docker     (127)   440984 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/fonts/FiraSans-Regular.ttf
--rw-r--r--   0 runner    (1001) docker     (127)   473160 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/fonts/FiraSans-SemiBold.ttf
--rw-r--r--   0 runner    (1001) docker     (127)   490704 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/fonts/FiraSans-SemiBoldItalic.ttf
--rw-r--r--   0 runner    (1001) docker     (127)   426752 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/fonts/FiraSans-Thin.ttf
--rw-r--r--   0 runner    (1001) docker     (127)   441292 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/fonts/FiraSans-ThinItalic.ttf
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-08 09:49:59.896356 dataset_tools-0.0.82/dataset_tools/image/
--rw-r--r--   0 runner    (1001) docker     (127)       83 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/image/__init__.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-08 09:49:59.896356 dataset_tools-0.0.82/dataset_tools/image/renders/
--rw-r--r--   0 runner    (1001) docker     (127)        0 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/image/renders/__init__.py
--rw-r--r--   0 runner    (1001) docker     (127)     1787 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/image/renders/convert.py
--rw-r--r--   0 runner    (1001) docker     (127)    11310 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/image/renders/horizontal_grid.py
--rw-r--r--   0 runner    (1001) docker     (127)    17874 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/image/renders/poster.py
--rw-r--r--   0 runner    (1001) docker     (127)     6309 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/image/renders/previews.py
--rw-r--r--   0 runner    (1001) docker     (127)     8047 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/image/renders/separated_anns_grid.py
--rw-r--r--   0 runner    (1001) docker     (127)    10407 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/image/renders/vertical_grid.py
--rw-r--r--   0 runner    (1001) docker     (127)     3649 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/image/renders/wrapper.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-08 09:49:59.900356 dataset_tools-0.0.82/dataset_tools/image/stats/
--rw-r--r--   0 runner    (1001) docker     (127)      139 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/image/stats/__init__.py
--rw-r--r--   0 runner    (1001) docker     (127)     3869 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/image/stats/basestats.py
--rw-r--r--   0 runner    (1001) docker     (127)    20151 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/image/stats/class_balance.py
--rw-r--r--   0 runner    (1001) docker     (127)    21119 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/image/stats/class_cooccurrence.py
--rw-r--r--   0 runner    (1001) docker     (127)    15161 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/image/stats/classes_per_image.py
--rw-r--r--   0 runner    (1001) docker     (127)    13318 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/image/stats/heatmaps_for_classes.py
--rw-r--r--   0 runner    (1001) docker     (127)    23459 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/image/stats/object_and_class_sizes.py
--rw-r--r--   0 runner    (1001) docker     (127)    11033 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/image/stats/objects_distribution.py
--rw-r--r--   0 runner    (1001) docker     (127)    23950 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/image/stats/preview_for_classes.py
--rw-r--r--   0 runner    (1001) docker     (127)    30179 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/image/stats/tags_cooccurrence.py
--rw-r--r--   0 runner    (1001) docker     (127)     7787 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/image/stats/wrapper.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-08 09:49:59.900356 dataset_tools-0.0.82/dataset_tools/repo/
--rw-r--r--   0 runner    (1001) docker     (127)        0 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/repo/__init__.py
--rw-r--r--   0 runner    (1001) docker     (127)     7112 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/repo/download.py
--rw-r--r--   0 runner    (1001) docker     (127)    41834 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/repo/project_repo.py
--rw-r--r--   0 runner    (1001) docker     (127)     6625 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/repo/sample_project.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-08 09:49:59.900356 dataset_tools-0.0.82/dataset_tools/templates/
--rw-r--r--   0 runner    (1001) docker     (127)      364 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/templates/__init__.py
--rw-r--r--   0 runner    (1001) docker     (127)      612 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/templates/annotation_types.py
--rw-r--r--   0 runner    (1001) docker     (127)    11536 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/templates/applications.py
--rw-r--r--   0 runner    (1001) docker     (127)    10641 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/templates/categories.py
--rw-r--r--   0 runner    (1001) docker     (127)     1341 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/templates/cv_tasks.py
--rw-r--r--   0 runner    (1001) docker     (127)    10334 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/templates/licenses.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-08 09:49:59.900356 dataset_tools-0.0.82/dataset_tools/text/
--rw-r--r--   0 runner    (1001) docker     (127)        0 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/text/__init__.py
--rw-r--r--   0 runner    (1001) docker     (127)    18589 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/dataset_tools/text/generate_summary.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-08 09:49:59.900356 dataset_tools-0.0.82/dataset_tools.egg-info/
--rw-r--r--   0 runner    (1001) docker     (127)     1965 2024-05-08 09:49:59.000000 dataset_tools-0.0.82/dataset_tools.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (127)     2735 2024-05-08 09:49:59.000000 dataset_tools-0.0.82/dataset_tools.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (127)        1 2024-05-08 09:49:59.000000 dataset_tools-0.0.82/dataset_tools.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (127)      568 2024-05-08 09:49:59.000000 dataset_tools-0.0.82/dataset_tools.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (127)       14 2024-05-08 09:49:59.000000 dataset_tools-0.0.82/dataset_tools.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (127)      119 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/pyproject.toml
--rw-r--r--   0 runner    (1001) docker     (127)       38 2024-05-08 09:49:59.904356 dataset_tools-0.0.82/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (127)     4299 2024-05-08 09:47:23.000000 dataset_tools-0.0.82/setup.py
...
### Comparing `dataset_tools-0.0.82/LICENSE` & `dataset-tools-0.0.9/LICENSE`

 * *Files identical despite different names*

### Comparing `dataset_tools-0.0.82/dataset_tools/convert/cityscapes/main.py` & `dataset-tools-0.0.9/dataset_tools/convert/cityscapes/main.py`

 * *Files identical despite different names*

### Comparing `dataset_tools-0.0.82/dataset_tools/convert/pascal/main.py` & `dataset-tools-0.0.9/dataset_tools/convert/pascal/main.py`

 * *Files identical despite different names*

### Comparing `dataset_tools-0.0.82/dataset_tools/image/renders/convert.py` & `dataset-tools-0.0.9/dataset_tools/image/renders/convert.py`

 * *Files identical despite different names*

### Comparing `dataset_tools-0.0.82/dataset_tools/image/renders/horizontal_grid.py` & `dataset-tools-0.0.9/dataset_tools/image/renders/horizontal_grid.py`
...
### Comparing `dataset_tools-0.0.82/dataset_tools/image/renders/separated_anns_grid.py` & `dataset-tools-0.0.9/dataset_tools/image/renders/vertical_grid.py`
...
### Comparing `dataset_tools-0.0.82/dataset_tools/image/renders/wrapper.py` & `dataset-tools-0.0.9/dataset_tools/image/renders/wrapper.py`
...
### Comparing `dataset_tools-0.0.82/dataset_tools/repo/sample_project.py` & `dataset-tools-0.0.9/dataset_tools/image/renders/separated_anns_grid.py`
...
### Comparing `dataset_tools-0.0.82/dataset_tools.egg-info/SOURCES.txt` & `dataset-tools-0.0.9/dataset_tools.egg-info/SOURCES.txt`
