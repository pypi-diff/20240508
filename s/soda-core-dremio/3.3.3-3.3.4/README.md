# Comparing `tmp/soda_core_dremio-3.3.3.tar.gz` & `tmp/soda_core_dremio-3.3.4.tar.gz`
...
## Comparing `soda_core_dremio-3.3.3.tar` & `soda_core_dremio-3.3.4.tar`
...
### Comparing `soda_core_dremio-3.3.3/LICENSE` & `soda_core_dremio-3.3.4/LICENSE`

 * *Files identical despite different names*

### Comparing `soda_core_dremio-3.3.3/soda/data_sources/dremio_data_source.py` & `soda_core_dremio-3.3.4/soda/data_sources/dremio_data_source.py`
