# Comparing `tmp/soda_core_scientific-3.3.3.tar.gz` & `tmp/soda_core_scientific-3.3.4.tar.gz`
...
### Comparing `soda_core_scientific-3.3.3/setup.py` & `soda_core_scientific-3.3.4/setup.py`
