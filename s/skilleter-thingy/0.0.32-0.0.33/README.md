# Comparing `tmp/skilleter_thingy-0.0.32.tar.gz` & `tmp/skilleter_thingy-0.0.33.tar.gz`
...
### Comparing `skilleter_thingy-0.0.32/skilleter_thingy/addpath.py` & `skilleter_thingy-0.0.33/skilleter_thingy/addpath.py`
