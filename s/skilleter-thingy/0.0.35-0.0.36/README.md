# Comparing `tmp/skilleter_thingy-0.0.35.tar.gz` & `tmp/skilleter_thingy-0.0.36.tar.gz`
...
### Comparing `skilleter_thingy-0.0.35/skilleter_thingy/addpath.py` & `skilleter_thingy-0.0.36/skilleter_thingy/addpath.py`
