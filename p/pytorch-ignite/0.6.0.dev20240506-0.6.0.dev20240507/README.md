# Comparing `tmp/pytorch-ignite-0.6.0.dev20240506.tar.gz` & `tmp/pytorch_ignite-0.6.0.dev20240507.tar.gz`
...
### Comparing `pytorch-ignite-0.6.0.dev20240506/ignite/metrics/regression/manhattan_distance.py` & `pytorch_ignite-0.6.0.dev20240507/ignite/metrics/regression/manhattan_distance.py`
...
### Comparing `pytorch-ignite-0.6.0.dev20240506/ignite/metrics/regression/mean_absolute_relative_error.py` & `pytorch_ignite-0.6.0.dev20240507/ignite/metrics/regression/mean_absolute_relative_error.py`

 * *Files identical despite different names*

### Comparing `pytorch-ignite-0.6.0.dev20240506/ignite/metrics/regression/mean_error.py` & `pytorch_ignite-0.6.0.dev20240507/ignite/metrics/regression/mean_error.py`

 * *Files identical despite different names*

### Comparing `pytorch-ignite-0.6.0.dev20240506/ignite/metrics/regression/mean_normalized_bias.py` & `pytorch_ignite-0.6.0.dev20240507/ignite/metrics/regression/mean_normalized_bias.py`

 * *Files identical despite different names*

### Comparing `pytorch-ignite-0.6.0.dev20240506/ignite/metrics/regression/median_absolute_error.py` & `pytorch_ignite-0.6.0.dev20240507/ignite/metrics/regression/median_absolute_error.py`

 * *Files identical despite different names*

### Comparing `pytorch-ignite-0.6.0.dev20240506/ignite/metrics/regression/median_absolute_percentage_error.py` & `pytorch_ignite-0.6.0.dev20240507/ignite/metrics/regression/median_absolute_percentage_error.py`

 * *Files identical despite different names*

### Comparing `pytorch-ignite-0.6.0.dev20240506/ignite/metrics/regression/median_relative_absolute_error.py` & `pytorch_ignite-0.6.0.dev20240507/ignite/metrics/regression/median_relative_absolute_error.py`

 * *Files identical despite different names*

### Comparing `pytorch-ignite-0.6.0.dev20240506/ignite/metrics/regression/pearson_correlation.py` & `pytorch_ignite-0.6.0.dev20240507/ignite/metrics/regression/pearson_correlation.py`

 * *Files identical despite different names*

### Comparing `pytorch-ignite-0.6.0.dev20240506/ignite/metrics/regression/r2_score.py` & `pytorch_ignite-0.6.0.dev20240507/ignite/metrics/regression/r2_score.py`

 * *Files identical despite different names*

### Comparing `pytorch-ignite-0.6.0.dev20240506/ignite/metrics/regression/wave_hedges_distance.py` & `pytorch_ignite-0.6.0.dev20240507/ignite/metrics/regression/wave_hedges_distance.py`

 * *Files identical despite different names*

### Comparing `pytorch-ignite-0.6.0.dev20240506/ignite/metrics/roc_auc.py` & `pytorch_ignite-0.6.0.dev20240507/ignite/metrics/roc_auc.py`

 * *Files identical despite different names*

### Comparing `pytorch-ignite-0.6.0.dev20240506/ignite/metrics/root_mean_squared_error.py` & `pytorch_ignite-0.6.0.dev20240507/ignite/metrics/root_mean_squared_error.py`

 * *Files identical despite different names*

### Comparing `pytorch-ignite-0.6.0.dev20240506/ignite/metrics/running_average.py` & `pytorch_ignite-0.6.0.dev20240507/ignite/metrics/running_average.py`

 * *Files identical despite different names*

### Comparing `pytorch-ignite-0.6.0.dev20240506/ignite/metrics/ssim.py` & `pytorch_ignite-0.6.0.dev20240507/ignite/metrics/ssim.py`

 * *Files identical despite different names*

### Comparing `pytorch-ignite-0.6.0.dev20240506/ignite/metrics/top_k_categorical_accuracy.py` & `pytorch_ignite-0.6.0.dev20240507/ignite/metrics/top_k_categorical_accuracy.py`

 * *Files identical despite different names*

### Comparing `pytorch-ignite-0.6.0.dev20240506/ignite/utils.py` & `pytorch_ignite-0.6.0.dev20240507/ignite/utils.py`

 * *Files identical despite different names*

### Comparing `pytorch-ignite-0.6.0.dev20240506/pyproject.toml` & `pytorch_ignite-0.6.0.dev20240507/pyproject.toml`

 * *Files identical despite different names*

### Comparing `pytorch-ignite-0.6.0.dev20240506/pytorch_ignite.egg-info/PKG-INFO` & `pytorch_ignite-0.6.0.dev20240507/pytorch_ignite.egg-info/PKG-INFO`
...
### Comparing `pytorch-ignite-0.6.0.dev20240506/pytorch_ignite.egg-info/SOURCES.txt` & `pytorch_ignite-0.6.0.dev20240507/pytorch_ignite.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `pytorch-ignite-0.6.0.dev20240506/setup.cfg` & `pytorch_ignite-0.6.0.dev20240507/setup.cfg`

 * *Files identical despite different names*

### Comparing `pytorch-ignite-0.6.0.dev20240506/setup.py` & `pytorch_ignite-0.6.0.dev20240507/setup.py`
