# Comparing `tmp/opentelemetry_instrumentation_watsonx-0.17.3.tar.gz` & `tmp/opentelemetry_instrumentation_watsonx-0.9.4.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "opentelemetry_instrumentation_watsonx-0.17.3.tar", max compression
+gzip compressed data, was "opentelemetry_instrumentation_watsonx-0.9.4.tar", max compression
```

## Comparing `opentelemetry_instrumentation_watsonx-0.17.3.tar` & `opentelemetry_instrumentation_watsonx-0.9.4.tar`

### file list

```diff
@@ -1,7 +1,5 @@
--rw-r--r--   0        0        0     1495 2024-05-08 17:16:09.581373 opentelemetry_instrumentation_watsonx-0.17.3/README.md
--rw-r--r--   0        0        0    17916 2024-05-08 17:16:09.581373 opentelemetry_instrumentation_watsonx-0.17.3/opentelemetry/instrumentation/watsonx/__init__.py
--rw-r--r--   0        0        0       42 2024-05-08 17:16:09.581373 opentelemetry_instrumentation_watsonx-0.17.3/opentelemetry/instrumentation/watsonx/config.py
--rw-r--r--   0        0        0      701 2024-05-08 17:16:09.581373 opentelemetry_instrumentation_watsonx-0.17.3/opentelemetry/instrumentation/watsonx/utils.py
--rw-r--r--   0        0        0       23 2024-05-08 17:16:09.581373 opentelemetry_instrumentation_watsonx-0.17.3/opentelemetry/instrumentation/watsonx/version.py
--rw-r--r--   0        0        0     1259 2024-05-08 17:16:38.189413 opentelemetry_instrumentation_watsonx-0.17.3/pyproject.toml
--rw-r--r--   0        0        0     2581 1970-01-01 00:00:00.000000 opentelemetry_instrumentation_watsonx-0.17.3/PKG-INFO
...
### Comparing `opentelemetry_instrumentation_watsonx-0.17.3/README.md` & `opentelemetry_instrumentation_watsonx-0.9.4/README.md`
...
### Comparing `opentelemetry_instrumentation_watsonx-0.17.3/pyproject.toml` & `opentelemetry_instrumentation_watsonx-0.9.4/pyproject.toml`
